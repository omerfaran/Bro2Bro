...
This element's definitions (required class names, html structures) are available in the [UI Docs](https://www.semantic-ui.com)

Please consider checking out [all the benefits to theming](https://www.learnsemantic.com/guide/expert.html) before using these stand-alone releases.
